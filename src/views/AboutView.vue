      ...
      <div class="flex flex-col">
        ...
        <div class="self-center w-1/2 h-screen transition-opacity flex flex-col items-start justify-center gap-y-6"
          ...
          <p>
            ...
            tutorials and creating my own text-based programs and games. I was
            immediately captivated by the versatility of the language and what I
            could build with it. Over the years, I've learned fullstack web
            development, gained skills in machine learning and built apps with
            flutter.
          </p>
          <p>
            Today, I am still looking to deepen my knowledge and explore new
            technologies. I've recently delved into functional programming and
            have gotten into CTFs.
          </p>
        ...
        <div class="h-screen transition-opacity flex items-center justify-center mx-96"
          ...
          <p>
            ...
            suscipit repellat, mollitia, recusandae labore facilis in sunt
            cumque autem praesentium vel perspiciatis, voluptatem laborum. Dolor
            magnam harum, minima in, delectus tenetur nam quo soluta
            necessitatibus numquam ullam explicabo, debitis illo reiciendis unde
            officiis fuga sunt ea ipsam maiores placeat omnis vitae. A ipsam
            fuga cupiditate, laborum ratione qui quisquam fugiat laboriosam
            deleniti minus ab similique beatae, id sapiente, vitae aliquid ad
            voluptate voluptatum minima autem libero culpa. Maxime autem labore
            nemo! Consequatur optio id similique ullam commodi ex dolorum
            consequuntur, dolorem qui error recusandae odio quisquam? Nostrum
            velit consectetur ullam!
          </p>
        </div>
      </div>
    </div>
